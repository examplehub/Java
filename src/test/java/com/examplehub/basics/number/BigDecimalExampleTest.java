...
class BigDecimalExampleTest {
    ...
    @Test
    void testSetScale() {
        assertEquals("123.4568", new BigDecimal("123.45678910").setScale(4, RoundingMode.UP).toString());
        assertEquals("123.45", new BigDecimal("123.45678910").setScale(2, RoundingMode.DOWN).toString());
    }
