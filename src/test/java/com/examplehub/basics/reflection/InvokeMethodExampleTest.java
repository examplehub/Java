...
//        assertEquals("hello", newStr); //TODO
    ...
    @Test
    void testInvokeStaticMethod() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        assertEquals(123, Integer.class.getMethod("parseInt", String.class).invoke(null, "123"));
    }

    @Test
    void testInvokePrivateMethod() throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        class MyObj {
            private String name;
    ...
    @Test
    void testPolymorphism() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        class Parent {
            public String hi() {
                return "Parent.hi";
            }
...
//    @Test TODO
    void testInvokeConstructorNoArgs() throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        class People {
            private String name;
    ...
    @Test
    void testInvokeConstructor() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
