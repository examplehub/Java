...
class ShuffleStringTest {
    @Test
    void testSolution1() {
        assertEquals("leetcode", ShuffleString.solution1("codeleet", new int[]{4, 5, 6, 7, 0, 2, 1, 3}));
        ...
        assertEquals("arigatou", ShuffleString.solution1("aaiougrt", new int[]{4, 0, 2, 6, 7, 3, 1, 5}));
