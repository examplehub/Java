...
class LongestCommonPrefixTest {
    ...
    void testSolution1() {
        ...
        assertEquals("flower", LongestCommonPrefix.solution1(new String[]{"flower","flower","flower","flower"}));
    ...
    void testSolution2() {
        ...
        assertEquals("flower", LongestCommonPrefix.solution2(new String[]{"flower","flower","flower","flower"}));
